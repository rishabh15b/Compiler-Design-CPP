...
%}
%start S
%token DO ID NUM T_lt T_gt T_lteq T_gteq T_neq T_eqeq T_and T_or T_incr T_decr T_not T_eq WHILE INT CHAR FLOAT VOID H MAINTOK INCLUDE BREAK CONTINUE IF ELSE COUT STRING FOR ENDL T_ques T_colon
...
PRINT
      : COUT T_lt T_lt STRING {lookup($1,@1.last_line,'K',NULL,NULL);lookup($4,@1.last_line,'S',NULL,NULL);}
      | COUT T_lt T_lt STRING T_lt T_lt ENDL {lookup($1,@1.last_line,'K',NULL,NULL);lookup($4,@1.last_line,'S',NULL,NULL);lookup($7,@1.last_line,'K',NULL,NULL);}
      ;
LIT
